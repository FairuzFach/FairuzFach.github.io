...
<body>
    <form runat="server">
		...
		<!-- <font color=8000FF> --!>
			<label for="user">Username</label> <asp:TextBox runat="server" ID="userID" maxlength="20" placeholder="Masukkan Username"/>
            <label for="user">Password</label> <asp:TextBox runat="server" ID="userPWD" maxlength="20" TextMode="Password" placeholder="Masukkan Password" />
        ...
        <script>
			...
			<asp:Button runat="server" onClick="Login_Click" cssClass="button" Text="Login"/>
        </div>
    </form>
